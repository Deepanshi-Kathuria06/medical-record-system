  ...
  const features = [
    {
      ...
      image: "/images/f1.png" // Replace with your image path
    },
    {
      ...
      image: "/images/f3.png" // Replace with your image path
    }
  ];
    ...
    <section className="relative py-24 overflow-hidden bg-gray-900">
      ...
      <div className="relative z-10 container mx-auto px-6">
        ...
        {features.map((feature, index) => (
          <div key={index} className={`flex flex-col ${index % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'} items-center gap-12 mb-32`}>
            {/* Image container */}
            <div className="w-full md:w-1/2 relative">
              <div className={`absolute -inset-4 bg-gradient-to-br ${index % 2 === 0 ? 'from-purple-600/10 to-blue-600/10' : 'from-blue-600/10 to-teal-600/10'} rounded-2xl blur-xl opacity-50`}></div>
              <img 
                src={feature.image} 
                alt={feature.title}
                className="relative rounded-xl w-full h-auto border border-gray-700/50 shadow-2xl"
              />
            </div>
            ...
            <div className="w-full md:w-1/2">
              ...
              <div className={`h-1 w-16 ${index % 2 === 0 ? 'bg-gradient-to-r from-purple-500 to-blue-500' : 'bg-gradient-to-r from-blue-500 to-teal-500'}`}></div>
            </div>
          </div>
        ))}
      </div>
